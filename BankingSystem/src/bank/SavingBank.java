...
import exceptions.SavingAccountWithdrawException;
...
public class SavingBank extends Bank {
    public void withdraw(SavingAccount account) throws SavingAccountWithdrawException {
        ...
        if (balance.compareTo(goalAmount) < 0) {
            throw new SavingAccountWithdrawException(balance, goalAmount);
        }
    }
    ...
    public SavingAccount createAccount() throws NoSuchElementException{
        ...
        try{
            ...
            BigDecimal goalAmount = requestAmount("목표금액을 입력하세요.");
